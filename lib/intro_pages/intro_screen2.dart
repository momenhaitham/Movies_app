...
class IntroScreen2 extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(
        children: [
          Image.asset(AppImages.intro2,fit: BoxFit.fill,),
          Image.asset(AppImages.intro2shade,fit: BoxFit.fill,),
          Column(
              mainAxisAlignment: MainAxisAlignment.end,
              crossAxisAlignment: CrossAxisAlignment.stretch,
              children: [
                Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(40),color: appColors.black),
